...
public class LPieceReverse extends AFigure{
	...
	public LPieceReverse(String colorHex, IObserver o, Field field, PlayingFieldCalculator pfc) {
	...
	public void generateBlocks() {
		XMLReader r = new XMLReader("LPieceReverse");
	...
	public void rotate() {
		if(rotateState == 1){
			...
			blocks.get(3).adjustPos(0, -2);
			rotateState=2;
		}
		else if(rotateState == 2){
			blocks.get(0).adjustPos(-1,1);
			//blocks.get(1).adjustPos(0, 0);
			blocks.get(2).adjustPos(1,-1);
			blocks.get(3).adjustPos(2, 0);
			rotateState=3;
		}
