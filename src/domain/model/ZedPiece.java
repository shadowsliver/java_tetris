...
public class ZedPiece extends AFigure{
	...
	public ZedPiece(String colorHex, IObserver o, Field field, PlayingFieldCalculator pfc) {
	...
	public void generateBlocks() {
		XMLReader r = new XMLReader("ZedPiece");
