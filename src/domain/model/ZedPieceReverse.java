...
public class ZedPieceReverse extends AFigure{
	...
	public ZedPieceReverse(String colorHex, IObserver o, Field field, PlayingFieldCalculator pfc) {
	...
	public void generateBlocks() {
		XMLReader r = new XMLReader("ZedPieceReverse");
	...
	public void rotate() {
		if(rotateState == 1){
			...
			blocks.get(0).adjustPos(-2,0);
			blocks.get(1).adjustPos(-1, 1);
			//blocks.get(2).adjustPos(,-1);
			blocks.get(3).adjustPos(1, 1);
			rotateState=3;
		}
